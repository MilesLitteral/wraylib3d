...
instance ToJSON Backend where
  toJSON v = case v of
    ...
    OpenXR10 -> object [ "tag" .= ("OpenXR10" :: Text)]
    Vulkan12 -> object [ "tag" .= ("Vulkan12" :: Text)]
    Vulkan13 -> object [ "tag" .= ("Vulkan13" :: Text)]
    Metal    -> object [ "tag" .= ("Metal"    :: Text)]
    D3D11    -> object [ "tag" .= ("D3D11"    :: Text)]
    D3D12    -> object [ "tag" .= ("D3D12"    :: Text)]
...
instance FromJSON Backend where
  parseJSON (Object obj) = do
    ...
    case tag :: Text of
      ...
      "OpenXR10" -> pure OpenXR10
      "Vulkan12" -> pure Vulkan12
      "Vulkan13" -> pure Vulkan13
      "Metal"    -> pure Metal
      "D3D11"    -> pure D3D11
      "D3D12"    -> pure D3D12
  parseJSON _ = mzero
