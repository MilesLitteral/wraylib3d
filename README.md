...
+ Core  (Module)
  ...
  + Script Engine
      - All Definitions for HRuby, later will be a generalized interface that the user can use to script ingame actions
        , mods, and logic. Planned support: Python(https://hackage.haskell.org/package/hpython), Ruby (https://hackage.haskell.org/package/hruby, custom build included that builds to Ruby 3.2), Lua (https://hackage.haskell.org/package/hslua)
