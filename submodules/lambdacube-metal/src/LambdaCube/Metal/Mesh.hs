...
addMeshToObjectArray :: MetalStorage -> String -> [String] -> GPUMesh -> IO Object
...
meshAttrToStream b i t = case t of 
                          (A_Float v) -> Stream Attribute_Float b i 0 (V.length v)
                          (A_V2F   v) -> Stream Attribute_V2F   b i 0 (V.length v)
                          (A_V3F   v) -> Stream Attribute_V3F   b i 0 (V.length v)
                          (A_V4F   v) -> Stream Attribute_V4F   b i 0 (V.length v)
                          (A_M22F  v) -> Stream Attribute_M22F  b i 0 (V.length v)
                          (A_M33F  v) -> Stream Attribute_M33F  b i 0 (V.length v)
                          (A_M44F  v) -> Stream Attribute_M44F  b i 0 (V.length v)
