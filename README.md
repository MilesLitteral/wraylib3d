...
## Notes:
*  lambdacube-metal requires now requires metal-cpp(https://developer.apple.com/metal/cpp/files/metal-cpp_macOS14.2_iOS17.2.zip), mtlpp(https://github.com/MilesLitteral/mtlpp) has been deprecated in favor of it.
*  Note if you wish to test the WebAssembly module you will need wasmtime installed on your machine: https://wasmtime.dev/. WASM support is extremely limited at the moment.
